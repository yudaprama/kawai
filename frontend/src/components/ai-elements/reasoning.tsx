...
export const ReasoningTrigger = memo(
  ({
    ...
    return (
      <CollapsibleTrigger
        className={cn(
          "inline-flex w-fit items-center gap-2 rounded-lg bg-muted/50 px-2.5 py-1.5 text-muted-foreground text-sm transition-colors hover:bg-muted hover:text-foreground",
          className
        )}
        {...props}
      >
