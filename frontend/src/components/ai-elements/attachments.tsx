...
const mediaCategoryIconUrls: Record<AttachmentMediaCategory, string> = {
  audio: `${FILE_ICON_CDN}/audio.svg`,
  document: `${FILE_ICON_CDN}/document.svg`,
  image: `${FILE_ICON_CDN}/image.svg`,
  source: `${FILE_ICON_CDN}/html.svg`,
  unknown: "",
  video: `${FILE_ICON_CDN}/video.svg`,
};
...
export const AttachmentPreview = ({
  ...
  const renderContent = () => {
    ...
    return fallbackIcon ?? renderIcon(iconUrl);
  };
