...
const registry: Record<string, ToolRenderer> = {
  ...
  ta_rsi: (o) => chart(twelveSeries(o, "rsi"), "RSI"),
  ta_sma: (o) => chart(twelveSeries(o, "sma"), "SMA"),
  ta_ema: (o) => chart(twelveSeries(o, "ema"), "EMA"),
  ta_macd: (o) => chart(twelveSeries(o, "macd"), "MACD"),
  ta_bbands: (o) => chart(twelveSeries(o, "middle_band"), "BBANDS (mid)"),
  get_crypto_ticker_24hr: renderTicker24,
  crypto_price: renderTicker24,
  crypto_depth: renderBinanceDepth,
  crypto_klines: (o) => chart(binanceKlineSeries(o)),
