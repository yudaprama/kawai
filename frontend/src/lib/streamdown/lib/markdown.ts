...
import { type Components as RuntimeComponents, type Jsx, toJsxRuntime } from "hast-util-to-jsx-runtime";
...
const post = (tree: Nodes, options: Readonly<Options>): ReactElement => {
  ...
  return toJsxRuntime(tree, {
    Fragment,
    components: options.components as Partial<RuntimeComponents> | undefined,
