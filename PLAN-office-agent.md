...
`rig-tools/tools/office` crate — those are generated HTTP catalogs; office
...
- **A Rust rig Tool already exists**: `rig-tools/tools/officecreate/`
...
- Reusing `rig-tools/tools/officecreate` as a git dep (needs publishing the
