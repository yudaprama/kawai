...
10. **Upstream PR: sentencepiece macOS fix.** Our vendored recipe (strip-to-src v0.2.2 + `PATCH.sentencepiece_darts` + absl seds) is PR-able to `google-ai-edge/LiteRT-LM`; merging it removes our local patch maintenance.
