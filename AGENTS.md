...
src-tauri/src/logic/scrape.rs    # web read tiering (office): web_read tool — on-device webview engine (injected trait) → Cloudflare /markdown fallback; challenge detection, daily budgets, LRU cache
